...
Aujourd'hui, la plus grande difficulté pour les développeurs front-end developers est **de travailler avec le DOM** pour créer du HTML dynamique, ce que React.js fait le mieux.
